...
Ein großer Vorteil des Box-Plots liegt darin, dass er schnelle Erkenntnisse zur Verteilung der erhobenen Daten liefert.

## Lagemaße

### Median:
Der Median wird durch die fettgedruckte Linie in der Box angezeigt. Die eine Hälfte der beobachteten Werte ist kleiner oder gleich dem Wert, die andere Hälfte der beobachteten Werte ist größer oder gleich dem Wert. Weitere Infos unter Zentralmaße.
