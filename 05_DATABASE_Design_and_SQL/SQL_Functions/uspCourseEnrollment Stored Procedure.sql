1 - uspCourseEnrollment stored procedure enrolls a student in a lecture. If the total credits of the courses taken by the student is greater than 90 or if the student has registered for the course before, registration is not made.
